...
public class WeatherPanel
  extends Panel
{
  private Color _backgroundColor = Configuration.getInstance().getColorProperty("weather-bar-background-color", new Color(0, 0, 0, 196));
  ...
  protected void paintComponent(Graphics graphics)
  {
    ...
    for (int x = 0; x < this.getWidth(); x++)
      {
        graphics2D.setPaint(new Color(_backgroundColor.getRed(), _backgroundColor.getGreen(), _backgroundColor.getBlue(), (int) (alphaDifference * x)));
