...
public class WAVERecorderThread
  extends Thread
{
  ...
  public WAVERecorderThread(AudioFormat _audioFormat, AudioFileFormat.Type _audioFileFormatType, File _file)
  ...
  public void run()
  {
    ...
    try
      {
        AudioSystem.write(_audioInputStream, _audioFileFormatType, _file);
      }
