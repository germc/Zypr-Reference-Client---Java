...
public class RadioStationListRowPanel
  extends JPanel
{
  private Label _labelLineNumber = new Label(SwingConstants.RIGHT);
  private Label _labelStationName = new Label();
  private Separator _separatorLine = new Separator();

  public RadioStationListRowPanel()
  {
    try
      {
        jbInit();
  ...
  public void setStationName(String contactName)
  {
    _labelStationName.setText(contactName);
  }
}
