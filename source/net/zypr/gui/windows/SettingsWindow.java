  ...
  extends ModalWindow
{
  ...
  private void jbInit()
    throws Exception
  {
    this.setSize(new Dimension(522, 285));
    this.setTitle("Settings");
    _buttonVoiceNote.setLocation(73, 15);
    ...
    _buttonTextToSpeech.setLocation(233, 15);
    ...
    _buttonMediaSource.setLocation(393, 15);
    ...
    _buttonPrivacy.setLocation(73, 90);
    ...
    _buttonServices.setLocation(233, 90);
    ...
    _buttonUnits.setLocation(393, 90);
    ...
    _buttonUser.setLocation(73, 170);
    ...
    _buttonSignOut.setLocation(233, 170);
    ...
    _buttonExit.setLocation(393, 170);
    ...
    _labelVoiceNote.setBounds(20, 65, 160, 15);
    _labelTextToSpeech.setBounds(180, 65, 160, 15);
    _labelMediaSource.setBounds(340, 65, 160, 15);
    _labelPrivacy.setBounds(20, 140, 160, 15);
    _labelServices.setBounds(180, 140, 160, 15);
    _labelUnits.setBounds(340, 140, 160, 15);
    _labelUser.setBounds(20, 220, 160, 15);
    _labelSignOut.setBounds(180, 220, 160, 15);
    _labelExit.setBounds(340, 220, 160, 15);
    _separatorHoriontal1.setBounds(20, 10, 1, 230);
    _separatorHoriontal2.setBounds(180, 10, 1, 230);
    _separatorHoriontal3.setBounds(340, 10, 1, 230);
    _separatorHoriontal4.setBounds(500, 10, 1, 230);
    _separatorVertical1.setBounds(20, 10, 480, 1);
    _separatorVertical2.setBounds(20, 85, 480, 1);
    _separatorVertical3.setBounds(20, 160, 480, 1);
    _separatorVertical4.setBounds(20, 240, 480, 1);
    ...
    _buttonMediaSource.setVisible(false);
    _labelMediaSource.setVisible(false);
    this.add(_panelContent, BorderLayout.CENTER);
  }

  protected void windowInvisible()
  {
    Session.getInstance().forceUpdateBGProcesses();
  }
