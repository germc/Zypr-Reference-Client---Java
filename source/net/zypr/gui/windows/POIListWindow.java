  ...
  extends ModalWindow
{
  ...
  private ItemVO[] _itemVOs = new ItemVO[0];
  private String _keyword = null;

  public POIListWindow(ItemVO[] itemVOs, String keyword)
  {
    super();
    _itemVOs = itemVOs;
    _keyword = keyword;
    ...
    throws Exception
  {
    ...
    setTitle(_keyword == null ? "Point Of Interest" : "Search results for " + _keyword);
