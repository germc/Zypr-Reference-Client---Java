  ...
  extends JXButton
{
  ...
  public Button(String iconDefault, String iconPressed, String iconDisabled, float alpha)
  {
    super();
    jbInit(iconDefault, iconPressed, iconDisabled, alpha);
  }

  public Button(String iconDefault, String iconPressed, float alpha)
  {
    super();
    jbInit(iconDefault, iconPressed, null, alpha);
  }

  public Button(String iconDefault, float alpha)
  {
    super();
    jbInit(iconDefault, null, null, alpha);
  }

  public Button(float alpha)
  {
    super();
    jbInit(null, null, null, alpha);
  }

  public Button(String iconDefault, String iconPressed, String iconDisabled)
  {
    super();
    jbInit(iconDefault, iconPressed, iconDisabled, 1.0f);
  }

  public Button(String iconDefault, String iconPressed)
  {
    super();
    jbInit(iconDefault, iconPressed, null, 1.0f);
  }

  public Button(String iconDefault)
  {
    super();
  ...
  protected void jbInit(String iconDefault, String iconPressed, String iconDisabled, float alpha)
  {
    ...
    setIcons(iconDefault, iconPressed, iconDisabled);
    setText("");
  ...
  public void setIcons(String iconDefault, String iconPressed, String iconDisabled)
  {
    ImageIcon imageIconDefault = null;
    ImageIcon imageIconPressed = null;
    ...
    try
      {
        if (iconPressed != null)
          imageIconPressed = Resources.getInstance().getImageIcon(iconPressed);
      }
    catch (Exception exception)
      {
        Debug.displayStack(this, exception);
    ...
    setIcons(imageIconDefault, imageIconPressed, imageIconDisabled);
  }

  public void setIcons(ImageIcon imageIconDefault, ImageIcon imageIconPressed, ImageIcon imageIconDisabled)
  {
    int width = getWidth();
    ...
    if (imageIconPressed != null)
      {
        setPressedIcon(imageIconPressed);
        if (imageIconPressed.getIconWidth() > width)
          width = imageIconPressed.getIconWidth();
        if (imageIconPressed.getIconHeight() > height)
          height = imageIconPressed.getIconHeight();
      }
  ...
  public void setIconPressed(ImageIcon iconPressed)
  {
    setIcons(null, iconPressed, null);
  }
