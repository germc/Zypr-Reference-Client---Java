...
{
  private static final MPlayer INSTANCE = new MPlayer();
  private static final int VLCSocket = 5124;
  ...
  public synchronized static MPlayer getInstance()
  {
    return (INSTANCE);
  }
        ...
        if (USE_VLC)
          {
            ...
            mVLCPlayer.Init(VLCSocket, _mPlayerProperties, "MediaPlayer");
          }
      }
